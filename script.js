function DefinirMatriz(){
    ...
    if (alt===""){
        ...
        alert("É necessário ter mais de uma alternativa e mais de um objetivo")
    } else{
        obj=Number(obj)+1
        alt=Number(alt)+2
...
function Comparar(){
    ...
    var comp=document.getElementById("matriz_final_princ")
    var comp2=document.getElementById("matriz_final_aux")
    var matriz_final_princ=[]
    var matriz_final_aux=[]
        ...
        for(var j=0; j<(colunas.length+2); j++){
            ...
            //demais colunas
                ...
                if(i==0){
                    ...
                    celula=document.getElementById("2matriz"+k+l).textContent
                    if (i==1){
                        matriz_final_princ.push(celula)
                    }
                    if (i==2){
                        matriz_final_aux.push(celula)
                    }
    ...
    comp.innerHTML=matriz_final_princ
    comp2.innerHTML=matriz_final_aux
...
function Analisado(){
    var mat_princ=document.getElementById("matriz_final_princ").textContent.split(",")
    var mat_aux=document.getElementById("matriz_final_aux").textContent.split(",")
    var alt = document.getElementById("Alternativas").value;
    alt=Number(alt)+2
    var princ = document.getElementsByName("obj1")
    for(var i=0; i<princ.length; i++) {
    ...
    var colunas=document.getElementById("var_sobraram").textContent.split(",")
    var comparacao=document.getElementById("3matriz11").value
    var cont
    var cont2
    cont=0
    cont2=0
    ...
    var column
    column=colunas.length+1
    if (document.getElementById("3matriz1"+column).textContent==document.getElementById("3matriz2"+column).textContent){
        for (var i=1; i<column;i++){
            if ((document.getElementById("3matriz1"+i).value-Number(mat_princ[i-1])==0 && document.getElementById("3matriz2"+i).value-Number(mat_aux[i-1])==0) || (document.getElementById("3matriz1"+i).value-Number(mat_princ[i-1])>0 && document.getElementById("3matriz2"+i).value-Number(mat_aux[i-1])<0) || (document.getElementById("3matriz1"+i).value-Number(mat_princ[i-1])<0 && document.getElementById("3matriz2"+i).value-Number(mat_aux[i-1])>0)){
                cont2=cont2+1
            }
        }
    }else{
